...
# --------------------------
with gr.Blocks(css=open("../UI/styles.css", "r").read(), theme="soft") as app:
    ...
    def logout_callback():
        ...
        return "Logged out.", gr.update(visible=False), gr.update(visible=False), gr.update(visible=True), gr.update(visible=False)
